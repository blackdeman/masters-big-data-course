...
echo "--- Create hfile ---"
hadoop jar hbase-examples-0.0.1-SNAPSHOT-job.jar com.cloudera.examples.hbase.bulkimport.Driver /tmp/$filename_prefix.tsv /tmp/$filename_prefix-hfile demchenko-$filename_prefix
